<x-app-layout>
    @php
        $title =
            app()->getLocale() == 'vi'
                ? 'Trang chủ | Grant Thornton TSC'
                : 'Home | Grant Thornton TSC';
    @endphp
    @section('title', $title)
    ...
    <section id="service-section"
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-2 xl:px-0 py-12 sm:py-24">
            ...
            <div class="flex flex-row flex-wrap justify-center gap-8 mt-12">
                ...
                $data = [
                    [
                        'svg' => '<svg xmlns="http://www.w3.org/2000/svg" width="1.2em" height="1.2em" viewBox="0 0 24 24"><path fill="currentColor" d="M3 20V7h6V4h6v3h6v13zm7-13h4V5h-4zm10 7.5h-6V16h-4v-1.5H4V19h16zm-9 .5h2v-2h-2zm-7-1.5h6V12h4v1.5h6V8H4zm8 .5" /></svg>',
                    ...
                    [
                        'svg' => '<svg width="1.2em" height="1.2em" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M9.5 10.5455H10.9545V12H9.5V10.5455ZM12.0455 10.5455H13.5V12H12.0455V10.5455ZM9.5 8H10.9545V9.45455H9.5V8ZM12.0455 8H13.5V9.45455H12.0455V8Z" fill="currentColor"/>
<path d="M8.77122 11.2693L2.08132 11.2693V4.48425H7.45758H12.8339V7.5L13.5 7.5V5.77487V4.48425C13.5 4.23508 13.4657 4.13851 13.3022 3.96232C13.1387 3.78614 13.0651 3.81994 12.8339 3.81994H9.96299V1.66584C9.96299 1.41667 9.99446 1.3266 9.83096 1.15041C9.66746 0.974229 9.57774 1.00153 9.34651 1.00153L5.95614 1.00153C5.72491 1.00153 5.3688 0.974227 5.2053 1.15041C5.0418 1.3266 4.98734 1.41667 4.98734 1.66584V3.81994H2.37183C2.14061 3.81994 1.91886 3.78614 1.75535 3.96232C1.59185 4.13851 1.5 4.23508 1.5 4.48425V11.0605C1.5 11.3097 1.59185 11.5487 1.75535 11.7248C1.91886 11.901 2.14061 12 2.37183 12H5.2053L8.77122 11.9859V11.2693ZM5.6026 1.66584H9.34651V3.81994H5.6026V1.66584Z" fill="currentColor"/>
</svg>
',
	...
	<path fill="currentColor" d="M7.827 10.635q-1.171 0-1.999-.828t-.828-2q0-1.17.828-1.998t1.999-.828t1.999.828t.828 1.999t-.828 1.999t-1.999.828m-.001-1q.76 0 1.294-.533t.534-1.293t-.533-1.295t-1.293-.533t-1.294.532Q6 7.046 6 7.806t.533 1.295q.532.533 1.293.533M16.192 19q-1.17 0-1.999-.828q-.827-.828-.827-1.999t.827-1.999t2-.828t1.998.828t.828 1.999t-.828 1.999t-1.999.828m0-1q.76 0 1.294-.533q.533-.532.533-1.293t-.532-1.294t-1.293-.534t-1.295.533q-.533.532-.533 1.293t.532 1.294t1.293.534m-10.31.808l-.689-.689L18.14 5.173l.688.688z" />
                    ...
                    [
                        'svg' => '<svg width="1.2em" height="1.2em" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
<path stroke="currentColor" d="M2.286 7.341V3.6C2.28368 3.47745 2.31895 3.35713 2.38706 3.25522C2.45518 3.15332 2.55287 3.07472 2.667 3.03L6.606 1.476C7.01536 1.30764 7.47463 1.30764 7.884 1.476L11.721 3.03C11.8374 3.07277 11.9376 3.15053 12.008 3.2526C12.0784 3.35467 12.1154 3.47603 12.114 3.6V7.341M2.286 7.341C2.286 10.689 5.766 13.041 7.26 13.041C8.754 13.041 12.114 10.68 12.114 7.341M2.286 7.341H12.114M7.2 1.35V13.05" stroke="black" stroke-width="0.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
',
                    ...
                    // </svg>
                    [
                        'svg' => '<svg xmlns="http://www.w3.org/2000/svg" width="1.2em" height="1.2em" viewBox="0 0 64 64">
