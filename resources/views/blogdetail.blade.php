...
{{--                    <livewire:star-record :record="$article" />--}}
            ...
            >
                ...
                <div class="w-full">
                    ...
                    <div class="pt-8">
                        <div
                            class="prose w-full max-w-full sm:max-w-screen-sm md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl px-4 sm:px-6 md:px-8 lg:px-12 mx-auto
                    ...
                    <div class="w-full pt-10 text-evening">
                        <div class="grid w-full place-items-center">
                            ...
                            >
                                <div
                                    style="
                                    background-image: url({{ $article->user->avatar }});
                                "
                        ...
                        <div class="mx-auto w-full max-w-md">
                            ...
                            <div class="w-full space-y-5 pt-7">
                                @foreach ($mostBlogs as $otherArticle)
                                    <a
                                        href="{{ route('admin.post.show', ['blogs' => $otherArticle]) }}"
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <x-articles.type-badge
                                                :type="showBadgeType($otherArticle->type)"
                                                size="sm"
                                            />
