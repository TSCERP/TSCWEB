@push('scripts')
    ...
    <div
        class="progress-wrap fixed right-8 bottom-6 h-12 w-12 cursor-pointer rounded-full shadow-[inset_0_0_0_2px_rgba(0,0,0,0.1)] z-[10000] opacity-0 invisible translate-y-4 transition-all duration-200 ease-linear">
