<x-app-layout>
    ...
    $watch('videoPopup', value => {
        ...
        <div class="bg-bg-main w-full h-24 -mb-2"
            ...
            <div
                ...
                <div class="flex flex-col md:flex-row gap-8 md:gap-0 content-around justify-around w-full">
                    ...
                    <div class="flex flex-col gap-4 items-center">
                        ...
                        <p class="text-white text-center">{{ __('Over 500 integrated multi-industry solutions') }}s
                        </p>
                    </div>
                    <div class="flex flex-col gap-4 items-center">
                ...
                <div class="flex flex-col md:flex-row justify-center gap-8 md:gap-4 w-full">
                    ...
                    <div class="flex flex-col w-full md:w-1/2 gap-8">
                        ...
                        <div class="flex gap-4">
                            ...
                            <div class="flex flex-col gap-3 flex-[12_12_0%]">
                                <h4 class="font-semibold text-lg">{{ __('Visual and Dynamic Analytical Reports') }}
                                </h4>
                ...
                <div class="flex flex-row flex-wrap  gap-8 mt-12 items-end rounded-full bg-">
                    @foreach ($features as $feature)
                        <div data-aos="zoom-in-right" data-aos-delay="0"
                            class="hover:scale-115 flex flex-col gap-4 justify-between cursor-default duration-300 ease-linear lg:h-[516px] sm:basis-[calc(50%-2rem)] md:basis-[calc(33.33%-2rem)] bg-white rounded px-6 py-6">
                            <div class="w-16 h-16">
                                <img class="w-16" src="{{ asset($feature['img']) }}" alt="sap-b1-pattern">
                            </div>
                            <div class="flex flex-col gap-4">
                                <h6 class="font-semibold text-2xl h-16 text-ellipsis overflow-hidden">
                                    {{ $feature['title'] }}</h6>
                                {{-- <h6 class="font-semibold text-2xl text-ellipsis overflow-hidden">
                                {{ $feature['title'] }}
                                </h6> --}}
        ...
        <section
            class="h-max bg-no-repeat bg-center bg-[length:auto_auto bg-[url('../assets/images/sap-video-bg.png')] bg-cover">
            <div
        ...
        <div>
            <!-- Popup container -->
            <div x-show="videoPopup" id="sap-video-modal"
                class="fixed inset-0 z-[10001] flex items-center justify-center bg-black bg-opacity-50 hidden"
